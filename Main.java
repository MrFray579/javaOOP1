...
public class Main {
    public static void main(String[] args) {
        ...
        List<Product> listBottle = new ArrayList<Product>(
            Arrays.asList(
                new Botlle("Coca Cola", 10.5, 0.5),
                new Botlle("Sprite", 10.2, 0.7)));
        
        //Объект Автомат напитков
        Machine bottleMachine = new BotlleMachine(listBottle);
        ...
        HotDrinksMachin hdMachime = new HotDrinksMachin(hotDrinksList);
        String drinkName = "Tea";
        Double drinkVolume = 0.4;
        Integer drinkTemp = 70;
        //System.out.println(hdMachime.getProductByName(keyHotDrinks)+" OK");
